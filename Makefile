...
# Project:  tetris.pro
# Template: app
# Command: C:\Qt\5.11.0\mingw53_32\bin\qmake.exe -o Makefile tetris.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: tetris.pro ../../mkspecs/win32-g++/qmake.conf ../../mkspecs/features/spec_pre.prf \
		../../mkspecs/qdevice.pri \
